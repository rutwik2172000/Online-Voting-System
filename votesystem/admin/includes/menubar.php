  ...
  <section class="sidebar" style="background-color: #BAB9B9">
    ...
    <div class="user-panel" style = "height: 60px">
      ...
      <div class="pull-left info "  >
        <p style="color:black ; font-size: 15px; font-family:Times"><?php echo $user['firstname'].' '.$user['lastname']; ?></p>
        <a><i class="fa fa-circle text-success "></i>  <b style=" color:black ; font-size: 15px; font-family:Times"> Online </b></a>
      </div>
    </div>
